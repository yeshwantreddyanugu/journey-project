  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-ocean text-primary-foreground hover:shadow-medium transition-bouncy font-semibold",
        whatsapp: "bg-[#25D366] text-white hover:bg-[#20BC5A] shadow-soft",
        accent: "bg-accent text-accent-foreground hover:bg-accent-hover shadow-soft",
        cta: "bg-gradient-sunset text-white hover:shadow-strong transition-bouncy font-semibold tracking-wide",
      },
      size: {
